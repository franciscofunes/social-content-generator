      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">AI Prompt Enhancer</h1>
              <p className="text-gray-600 dark:text-gray-400">Transform your ideas into optimized BRIA AI prompts</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Example Ideas */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Example Ideas</h3>
              <div className="space-y-3">
                {ideaCategories.map((category, index) => (
                  <div key={index} className="border border-gray-200 dark:border-gray-600 rounded-lg p-3 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer" onClick={() => setUserInput(`${category.name.toLowerCase()} scene`)}>
                    <div className="flex items-start gap-2">
                      <category.icon className="h-4 w-4 mt-0.5 flex-shrink-0 text-purple-600 dark:text-purple-400" />
                ...
                <div className="space-y-4">
                  {tipCategories.map((tip, index) => (
                    <div key={index} className="border-l-4 border-purple-500 pl-4">
                      <h4 className="font-semibold text-gray-900 dark:text-white text-sm break-words">{tip.title}</h4>
          ...
          <div className="space-y-6 min-w-0">
            {/* User Input */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Describe Your Image</h3>
              <textarea
                value={userInput}
                ...
                className="w-full h-32 p-4 border border-gray-300 dark:border-gray-600 rounded-lg resize-none focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm leading-relaxed"
                rows={4}
              />
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
              ...
              {currentPrompt ? (
                <>
                  <div className="mb-4">
                    <textarea
                      ...
                      className="w-full h-40 p-4 border border-gray-300 dark:border-gray-600 rounded-lg resize-none focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm leading-relaxed"
                      rows={8}
                    />
                    <div className="flex items-center justify-between mt-2 text-sm text-gray-500 dark:text-gray-400">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-2">No enhanced prompt yet</p>
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800">
              <h4 className="font-semibold text-purple-900 dark:text-purple-100 mb-3">Quick Actions</h4>
              <div className="grid grid-cols-2 gap-2">
                <Button
                  variant="ghost"
                  size="sm"
                  className="justify-start text-purple-700 dark:text-purple-300 hover:bg-purple-100 dark:hover:bg-purple-800"
                  onClick={() => {
                    if (currentPrompt) {
                      const encodedPrompt = encodeURIComponent(currentPrompt);
                      window.open(`/images?prompt=${encodedPrompt}`, '_blank');
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Saved Prompts</h3>
              ...
              {loadingPrompts ? (
                ...
                <div className="space-y-3">
                  {savedPrompts.map((promptObj) => (
                    ...
                    >
                      <p className="text-sm text-gray-900 dark:text-white mb-2 line-clamp-3 leading-relaxed break-words">
                        {promptObj.prompt}
                      </p>
